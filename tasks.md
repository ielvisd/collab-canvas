...
- [ ] **Setup Nuxt 4 project with TypeScript**
  - Initialize Nuxt 4 with `npx nuxi@latest init collabcanvas`
  - Configure TypeScript support
  - Setup basic folder structure (`/components`, `/composables`, `/pages`, `/utils`)
...
- [ ] **Setup linting, formatting, and testing infrastructure**
  - Install and configure ESLint with Nuxt preset
  - Setup Prettier with `.prettierrc`
  - Install Vitest for unit testing
  - Install Playwright for E2E testing
  - Create basic GitHub Actions workflow file (`.github/workflows/ci.yml`)
...
- [ ] **Install and configure Nuxt UI component library**
  - Install `@nuxt/ui` module
  - Configure Nuxt UI in `nuxt.config.ts`
  - Setup Tailwind CSS (comes with Nuxt UI)
  - Create basic layout component using Nuxt UI
  - Test a few sample components (Button, Card, Input)
  - Document available components for reference
